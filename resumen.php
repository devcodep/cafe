...
<div class="ui relaxed divided list">
  <div class="item">
<img class="ui avatar image" src="https://espressoparaguay.com/wp-content/uploads/2018/04/cap_arpeggio.jpg">
    <div class="content">
      <a class="header">Intenso</a>
      <div class="description">4 capsulas</div>
    </div>
  </div>
  <div class="item">
<img class="ui avatar image" src="https://espressoparaguay.com/wp-content/uploads/2018/04/cap_arpeggio.jpg">
    <div class="content">
      <a class="header">Espresso</a>
      <div class="description">2 capsulas</div>
    </div>
  </div>
...
<img class="ui avatar image" src="https://espressoparaguay.com/wp-content/uploads/2018/04/cap_arpeggio.jpg">
    <div class="content">
      <a class="header">Lungo</a>
      <div class="description">1 capsula</div>
    </div>
  </div>
    <h3 class="ui center aligned header">Resumen de Capsulas 7 Totales
    <div class="ui buttons center aligned">
  <button class="ui button">Continuar</button>
  <div class="or"></div>
  <button class="ui positive button">Modificar</button>
</div><br />
</h3>
</div>
